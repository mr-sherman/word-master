        ...
        <div className="h-full flex flex-col items-center justify-center max-w-[300px] mx-auto text-primary dark:text-primary-dark">
          ...
          {gameState === state.won && (
            <>
              ...
              <h1 className=" text-3xl">Felicitaciónes!</h1>
              <p className="mt-6">
                Racha: <strong>{currentStreak}</strong> {currentStreak > 4 && '🔥'}
              </p>
              <p>
                Racha mas larga: <strong>{longestStreak}</strong>
              </p>
            </>
          )}
            ...
            <>
              ...
              <div className="text-primary dark:text-primary-dark text-4xl text-center">
                ...
                <p className="mt-3 text-2xl">
                  La palabra es <strong>{answer}</strong>
                </p>
